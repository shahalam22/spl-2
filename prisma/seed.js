...
async function main() {
  ...
  await prisma.post.deleteMany(); // Remove all existing posts
    ...
    data: [
      {
        ...
        category_id: 1,
        isRequest: false,
        title: "Handmade Oil Painting",
        description: "A beautiful handmade oil painting on canvas.",
        price: 300,
        quantity: 1,
        status: "Available",
        condition: "new",
        ...
        pickup: { date: "2025-04-10", time: "14:00" },
        delivery: "Available for local pickup or shipping.",
        impactinfo: "Supports local artists and creativity.",
      ...
      },
      {
        ...
        description: "A stylish vintage wooden chair, perfect for home decor.",
        price: 120,
        quantity: 2,
        status: "Available",
        condition: "used",
        ...
        updatedAt: new Date(),
        location: {
          street: "789 Retro Lane",
          city: "San Francisco",
          state: "CA",
          zip: "94103",
          country: "USA"
        },
        pickup: { date: "2025-04-15", time: "10:30" },
        delivery: "Pickup only.",
        impactinfo: "Eco-friendly choice for sustainable living.",
      ...
      },
      {
        ...
        updatedAt: new Date(),
        location: {
          street: "101 Tech Street",
          city: "Austin",
          state: "TX",
          zip: "73301",
          country: "USA"
        },
        pickup: { date: "2025-04-20", time: "12:00" },
        delivery: "Shipping available nationwide.",
        impactinfo: "Enables high-performance gaming and work.",
      ...
      },
      {
        ...
        category_id: 4,
        isRequest: true,
        title: "Seeking Winter Jackets",
        description: "Looking for winter jacket donations for homeless shelters.",
        price: 0,
        quantity: 10,
        status: "Pending",
        condition: "used",
        ...
        updatedAt: new Date(),
        location: {
          street: "222 Charity Lane",
          city: "Chicago",
          state: "IL",
          zip: "60601",
          country: "USA"
        },
        pickup: { date: "2025-05-01", time: "11:00" },
        delivery: "Pickup preferred, delivery possible for large donations.",
        impactinfo: "Helping those in need stay warm during winter.",
        images: []
      },
      {
        user_id: 5,
        ...
        description: "A collection of classic literature books in mint condition.",
        price: 80,
        quantity: 5,
        status: "Available",
        condition: "new",
        ...
        updatedAt: new Date(),
        location: {
          street: "303 Book Street",
          city: "Seattle",
          state: "WA",
          zip: "98101",
          country: "USA"
        },
        pickup: { date: "2025-06-10", time: "15:00" },
        delivery: "Shipping available nationwide.",
        impactinfo: "Promoting literacy and education.",
        images: ["books1.jpg", "books2.jpg"]
      }
    ]
  });

  console.log("Database successfully updated with new posts!");
}
